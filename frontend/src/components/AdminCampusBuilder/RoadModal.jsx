    ...
    <div className="fixed inset-0 z-[1000] bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Draw or configure campus pathways
              </p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">
              From Building <span className="text-xs text-slate-400">(Optional)</span>
            </label>
            <select
              ...
              className="w-full border border-slate-300 rounded-xl px-3 py-2.5"
            >
              <option value="">-- None / Free Path --</option>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">
              To Building <span className="text-xs text-slate-400">(Optional)</span>
            </label>
            <select
          ...
          <div>
            ...
            <div className="flex gap-3">
              <input
                ...
                className="w-14 h-10 cursor-pointer rounded-lg border border-slate-300 bg-white p-1"
              />
              <input
                type="text"
                value={roadForm.color}
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 text-sm text-blue-700">
            You can create roads freely without tying them to specific buildings.
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-t flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-sm"
          >
            Create Road
          </button>
        </div>
